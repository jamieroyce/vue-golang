...
build: static
	for target in $(WHAT); do \
		go build -ldflags "-X github.com/jamieroyce/vue-golang/pkg/version.Version=${VERSION} \
			-X github.com/jamieroyce/vue-golang/pkg/version.Revision=${REVISION} \
			-X github.com/jamieroyce/vue-golang/pkg/version.Branch=${BRANCH} \
			-X github.com/jamieroyce/vue-golang/pkg/version.BuildUser=${BUILDUSER} \
			-X github.com/jamieroyce/vue-golang/pkg/version.BuildDate=${BUILDTIME}" \
			-o ./bin/$$target ./cmd/$$target; \
	done

build-darwin-amd64:
	for target in $(WHAT); do \
		CGO_ENABLED=0 GOARCH=amd64 GOOS=darwin go build -a -installsuffix cgo -ldflags "-X github.com/jamieroyce/vue-golang/pkg/version.Version=${VERSION} \
			-X github.com/jamieroyce/vue-golang/pkg/version.Revision=${REVISION} \
			-X github.com/jamieroyce/vue-golang/pkg/version.Branch=${BRANCH} \
			-X github.com/jamieroyce/vue-golang/pkg/version.BuildUser=${BUILDUSER} \
			-X github.com/jamieroyce/vue-golang/pkg/version.BuildDate=${BUILDTIME}" \
...
build-linux-amd64:
	for target in $(WHAT); do \
		CGO_ENABLED=0 GOARCH=amd64 GOOS=linux go build -a -installsuffix cgo -ldflags "-X github.com/jamieroyce/vue-golang/pkg/version.Version=${VERSION} \
			-X github.com/jamieroyce/vue-golang/pkg/version.Revision=${REVISION} \
			-X github.com/jamieroyce/vue-golang/pkg/version.Branch=${BRANCH} \
			-X github.com/jamieroyce/vue-golang/pkg/version.BuildUser=${BUILDUSER} \
			-X github.com/jamieroyce/vue-golang/pkg/version.BuildDate=${BUILDTIME}" \
...
build-windows-amd64:
	for target in $(WHAT); do \
		CGO_ENABLED=0 GOARCH=amd64 GOOS=windows go build -a -installsuffix cgo -ldflags "-X github.com/jamieroyce/vue-golang/pkg/version.Version=${VERSION} \
			-X github.com/jamieroyce/vue-golang/pkg/version.Revision=${REVISION} \
			-X github.com/jamieroyce/vue-golang/pkg/version.Branch=${BRANCH} \
			-X github.com/jamieroyce/vue-golang/pkg/version.BuildUser=${BUILDUSER} \
			-X github.com/jamieroyce/vue-golang/pkg/version.BuildDate=${BUILDTIME}" \
