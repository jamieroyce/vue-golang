...
```sh
git clone github.com/jamieroyce/vue-golang
...
You can build and run the **Go &#9829; Vue Starter** by your own or you can use the [prebuild binaries](https://github.com/jamieroyce/vue-golang/releases). Befor you start the **Go &#9829; Vue Starter** edit the `config.yml` file:
